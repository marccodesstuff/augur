...
public sealed class AugurDbContext : DbContext
{
    ...
    /// <summary>Control mappings across frameworks (cross-framework compliance).</summary>
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ControlMapping>(builder =>
        {
            ...
            builder.Property(m => m.SourceControlId).IsRequired();
            builder.Property(m => m.SourceFramework).HasConversion<int>().IsRequired();
            builder.Property(m => m.SourceControlCode).IsRequired().HasMaxLength(50);
            builder.Property(m => m.TargetFramework).HasConversion<int>().IsRequired();
            builder.Property(m => m.TargetControlCode).IsRequired().HasMaxLength(50);
            builder.Property(m => m.TargetControlTitle).IsRequired().HasMaxLength(200);
            builder.Property(m => m.ConfidenceScore).IsRequired();
            builder.Property(m => m.Rationale).HasMaxLength(1000);
            builder.Property(m => m.IsAutoGenerated).IsRequired();
            builder.HasIndex(m => new { m.SourceControlId, m.TargetFramework }).IsUnique();
        });
