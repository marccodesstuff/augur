...
/// <summary>Read model for a <see cref="ControlMapping"/> across frameworks.</summary>
public sealed class ControlMappingDto
{
    ...
    public Guid SourceControlId { get; init; }

    /// <summary>Source control code.</summary>
    public string SourceControlCode { get; init; } = string.Empty;

    /// <summary>Source framework.</summary>
    public string SourceFramework { get; init; } = string.Empty;

    /// <summary>Target control code.</summary>
    public string TargetControlCode { get; init; } = string.Empty;

    /// <summary>Target control title.</summary>
    public string TargetControlTitle { get; init; } = string.Empty;
    ...
    /// <summary>Mapping rationale.</summary>
    public string Rationale { get; init; } = string.Empty;

    /// <summary>Whether auto-generated or manually curated.</summary>
